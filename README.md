...
### 3. [GitHub](https://github.com/NIFTYCloud-mbaas/ObjcSegmentPushApp_iOS)からサンプルプロジェクトのダウンロード
　
* 下記リンクをクリックしてプロジェクトをダウンロードをMacにダウンロードします

 * __[ObjcSegmentPushApp_iOS](https://github.com/NIFTYCloud-mbaas/ObjcSegmentPushApp_iOS/archive/master.zip)__
...
#### SDKのインポートと初期設定
* ニフティクラウド mobile backend の[ドキュメント（クイックスタート）](http://mb.cloud.nifty.com/doc/current/introduction/quickstart_ios.html)をObjective-C版に書き換えたドキュメントをご用意していますので、ご活用ください
 ...
 * [Swift版](https://github.com/NIFTYCloud-mbaas/SwiftSegmentPushApp)
